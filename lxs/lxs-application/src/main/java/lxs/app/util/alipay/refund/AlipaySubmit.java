package lxs.app.util.alipay.refund;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import lxs.app.util.httpClient.HttpProtocolHandler;
import lxs.app.util.httpClient.HttpRequest;
import lxs.app.util.httpClient.HttpResponse;
import lxs.app.util.httpClient.HttpResultType;
