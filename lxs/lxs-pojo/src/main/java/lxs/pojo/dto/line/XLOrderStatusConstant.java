...
import lxs.pojo.util.line.Attr;
...
//			SHOP_XLORDER_PAY_STATUS_MAP.put(SHOP_RECEIVE_BALANCE_MONEY_WAIT_PAY_FX,SHOP_RECEIVE_BALANCE_MONEY_WAIT_PAY_FX_VAL);
	...
	/*------------分销线路订单状态-begin----------------------------------------------*/
		//订单状态
		public static final String SLFX_CREATE_SUCCESS_NOT_RESERVE = "2001";
		public static final String SLFX_CREATE_SUCCESS_LOCK_SEAT = "2002";
		public static final String SLFX_RESERVE_SUCCESS = "2003";
		public static final String SLFX_ORDER_CANCEL = "2004";
		public static final String SLFX_ORDER_SUCCESS = "2005"; //
		...
		//订单支付状态
		public static final String SLFX_WAIT_PAY_BARGAIN_MONEY = "2101";
		// 为了和直销状态方便转化作+1000 操作
		public static final String SLFX_PAY_BARGAIN_MONEY = "2102";
		public static final String SLFX_WAIT_PAY_BALANCE_MONEY = "2103";
		public static final String SLFX_PAY_SUCCESS = "2105";
		public static final String SLFX_WAIT_REFUND = "2106";

		public static final String SLFX_WAIT_PAY_DIFFERENCE_MONEY = "2107"; //
		public static final String SLFX_REFUND_SUCCESS = "2108";
