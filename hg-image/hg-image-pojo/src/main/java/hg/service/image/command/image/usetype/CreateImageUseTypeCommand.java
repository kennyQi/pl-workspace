 ...
 */
public class CreateImageUseTypeCommand extends BaseCommand {
	...
	public CreateImageUseTypeCommand() {
	}

	public CreateImageUseTypeCommand(String projectId, String envName) {
