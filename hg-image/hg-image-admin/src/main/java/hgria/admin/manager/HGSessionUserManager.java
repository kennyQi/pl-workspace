 ...
 */
public class HGSessionUserManager {
	 ...
	 * @throws
	 */
	public static void login(Subject currentUser, AuthUser user, Project project) {
		currentUser.getSession().setAttribute(SESSION_USER_KEY, user);
		currentUser.getSession().setAttribute(SESSION_PROJECT_KEY, project);
	}
	 ...
	 * @throws
	 */
	public static Project getSessionProject(HttpServletRequest request) {
		return (Project) request.getSession().getAttribute(SESSION_PROJECT_KEY);
	}
