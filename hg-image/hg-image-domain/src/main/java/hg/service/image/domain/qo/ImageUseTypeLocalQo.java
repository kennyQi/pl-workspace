 ...
 */
public class ImageUseTypeLocalQo extends ImageBaseLocalQo {
	...
	public ImageUseTypeLocalQo(){
	}
	public ImageUseTypeLocalQo(String projectId, String envName) {
		super(projectId, envName);
	}
	public ImageUseTypeLocalQo(String id) {
		super(id);
	}
