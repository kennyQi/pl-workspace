...
public class HjfInviteFriendsLogic extends BaseSingleRule implements RuleLogic {
	...
	public CalResult compute(Serializable flow) throws Exception {
		...
		integralIncrement = Integer.parseInt(rule.parameters.get("integralIncrement"));// @REMARK@用户邀请好友得到的积分数量
