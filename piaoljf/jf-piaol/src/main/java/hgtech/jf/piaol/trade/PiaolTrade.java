...
public class PiaolTrade implements Serializable{
	 ...
	 * 话费充值抽奖
	 */
	public final static String TRADE_HFCHOUJIAGN="hfchoujiang";
	/**
	 * 查询优惠券是否可用
	 */
	 ...
	 * 根据事件赠送汇金豆
	 */
	public final static String TRADE_GIVEHJDBYEVENT = "giveHJDByEvent";
	/**
	 * 赠送汇金豆事件
	 * 点评送汇金豆
	 */
	public final static String TRADE_GIVEHJDBY_DIANPING = "点评送汇金豆";
	/**
	 * 赠送汇金豆事件
	 * 支付宝充值送汇金豆
	 */
	public final static String TRADE_GIVEHJDBY_CHONGZHI = "支付宝充值送汇金豆";
