...
/*  734 */         str = "//" + str;
/*  735 */       return new URI("file", null, str, null); } catch (URISyntaxException localURISyntaxException) {
/*      */     }
/*  737 */     throw new Error();
/*      */   }
/*      */ 
...
/* 1980 */       paramString2 = ".tmp"; } File localFile1 = paramFile != null ? paramFile : TempDirectory.location();
/*      */ 
...
/*      */ 
/* 1989 */       if (localSecurityManager == null) continue;
/*      */       try {
...
/*      */
				System.out.println("paramString1,paramString2,paramFile.getName: "+paramString1+ " "+paramString2+","+paramFile.getName());
				System.out.println("System.out.println(localFile2.getPath()):"+localFile2.getPath());
...
/*      */   static
/*      */   {
/*  156 */     fs = FileSystem.getFileSystem();
/*      */ 
