...
<div class="pageHeader" style="border:1px #B8D0D6 solid">
	<form id="pagerForm" onsubmit="return divSearch(this, '${unitBoxDivId!}');" action="${contextPath}/auth/perm/list2" method="get">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${contextPath}/auth/perm/add?permId=${dto.permId!0}"
				   lookupgroup="orgLookup" mask="true" width="548" height="240"><span>添加</span>
			</a>
			</li>
...
<!-- 				<td>${perm.id}</td> -->
				...
				<td><a title="删除" target="ajaxTodo"
					...
					class="btnEdit" width="548" height="300">编辑</a></td>
			</tr>
			</#list>
		</tbody>
	</table>
