package pl.admin.controller.system;
...
public class OperatorController extends BaseController {
	...
	public String save(@RequestParam(value="realName", required=false)String realName,
		...
		if(exist){
			...
			logger.info("保存新增的操作员:保存失败，登录名已经存在");
