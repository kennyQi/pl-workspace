...
import pl.h5.base.weixin.ButtonOfWxCustomMenu;
import pl.h5.base.weixin.TokenAndExpiresOfWx;
import pl.h5.base.weixin.WxCustomMenu;
...
public class InitializeListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		TokenAndExpiresOfWx object=null;
		String accessToken=null;
		try{
			object = WxUtil.getWxAccessTokenFromWx(SysProperties.getInstance().get("wx_app_id"), SysProperties.getInstance().get("wx_app_secret"));
			accessToken = object.getAccess_token();
		}catch(Exception e){
			e.printStackTrace();
		}
