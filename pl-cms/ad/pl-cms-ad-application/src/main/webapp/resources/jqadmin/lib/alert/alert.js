(function(a) {
    a.alerts = {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            a("body").append('<div id="popup_container" style="display:none"><h1 id="popup_title"></h1><span id="popup_close"></span><div id="popup_content"><div id="popup_message"></div></div></div>');
            if (a.alerts.dialogClass) {
    ...
    for (var i = 0; i < js.length; i++) {
        if (js[i].src.toLowerCase().indexOf("/alert.js") != -1) {
    ...
    css.setAttribute("href", jsPath + "alert.css");
