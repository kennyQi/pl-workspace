    ...
    <form id="Form1" runat="server">
        <div id="main">
            <div id="head">
                ...
                <span class="title">支付宝客户解约接口快速通道</span>
            </div>
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <asp:TextBox ID="WIDcustomer_code" name="WIDcustomer_code" runat="server"></asp:TextBox>
                        <span>type_code协议对应的唯一的编号。</span>
                    </dd>
                    <dt>代理业务编号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDbiz_type" name="WIDbiz_type" runat="server"></asp:TextBox>
                        <span>取值参见接口技术文档</span>
                    </dd>
                    <dt>客户支付宝账号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDuser_email" name="WIDuser_email" runat="server"></asp:TextBox>
                        <span>由于解约方式多样化因此以上所有参数的设置请参见接口技术文档</span>
                    </dd>
                    <dt></dt>
                    <dd>
