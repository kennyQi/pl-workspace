package hg.dzpw.admin.controller;
...
public class BaseDateController extends BaseController {
	...
	public String area(@ModelAttribute AreaQo areaQo){
		HgLogger.getInstance().info("zzb", "进入县市查询方法:areaQo【" + areaQo + "】");
		List<Area> list = this.areaServiceImpl.queryList(areaQo);
