...
public class LoginController extends BaseController {
	...
	public RedirectView submit(Model model, 
			HttpServletRequest request, 
			@ModelAttribute MerchantLoginCommand command) {
		...
		try {
			MerchantSessionUserVo vo = scenicSpotLocalService.loginCheck(command);
			MerchantSessionUserManager.login(request, vo);
	...
	public Object out(HttpServletRequest request) {
		MerchantSessionUserManager.logout(request);
	...
	public String changePassword(
			HttpServletRequest request,
			@ModelAttribute ModifyLoginScenicspotPasswordCommand command) {
		try {
			command.setScenicspotId(MerchantSessionUserManager.getSessionUserId(request));
			scenicSpotLocalService.modifyLoginScenicspotPassword(command);
