package hg.dzpw.app.component.aop;
...
import hg.dzpw.pojo.common.BaseParam;
...
public class ServiceAspect {
	...
	public void setServiceAopHglog(String monitor) {
		if (monitor == null)
			return;
		this.monitor = monitor.trim().toLowerCase().equals("true") ? true : false;
	}
			...
			for (int i = 0; i < objs.length; i++) {
				...
				if (obj == null)
					sb.append("null");
						...
						|| obj instanceof BaseQo 
						|| obj instanceof BaseCommand 
						|| obj instanceof Pagination
						|| obj instanceof ApiRequest
						|| obj instanceof ApiRequestBody
						|| obj instanceof hg.dzpw.pojo.api.appv1.base.ApiRequestBody)
