...
public class AlipayCore {
	 ...
	 * 
	 * @author: guotx 
	 * @version: 2016-3-10 上午11:12:37
	 */
	public static String getRandomBatchNo(){
		String dateString=DateUtil.formatDateTime(new Date(), "yyyyMMddHHmmss");
		String serialString=RandomStringUtils.randomNumeric(5);
		return dateString+serialString;
	}
}
