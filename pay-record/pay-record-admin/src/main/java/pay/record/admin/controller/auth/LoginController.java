package pay.record.admin.controller.auth;
...
public class LoginController extends BaseController {
	...
	private static final String SESSION_VALID_CODE_KEY = "_PLFX_SESSION_VALID_CODE_";
	...
	protected boolean validCodeCheck(HttpServletRequest request, String validCode) {
		...
		String sessionValidCode = (String) request.getSession().getAttribute(SESSION_VALID_CODE_KEY);
		request.getSession().removeAttribute(SESSION_VALID_CODE_KEY);
	...
	public void getKaptchaImage(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		session.setAttribute(SESSION_VALID_CODE_KEY, capText);
