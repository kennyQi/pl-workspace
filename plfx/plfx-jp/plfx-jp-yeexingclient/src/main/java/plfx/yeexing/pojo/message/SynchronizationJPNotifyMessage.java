...
public class SynchronizationJPNotifyMessage extends BaseAmqpMessage<JPNotifyMessageApiCommand>{
	
	/**
	 * 设置消息内容
	 * @param command
	 */
	public void setMessageContent(JPNotifyMessageApiCommand command){
		setContent(command);
	}
