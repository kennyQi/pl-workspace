...
public class MpEnumConstants {
	...
	public final static class CacheKeyEnum {
		...
		/** 景点详情（图文） */
		public final static String CACHE_KEY_SCENIC_SPOT_DETAIL = "scenic_spot_detail_cache";
		/** 没有门票的景点ID */
		public final static String CACHE_KEY_NO_POLICE_SCENIC_SPOT_ID = "no_police_scenic_spot_id_cache";
	}
	...
	public final static class ExceptionCode {
		...
		/** 订单不存在 */
		public final static String EXCEPTION_CODE_ORDER_NOT_EXITS = "SLFX-MP-1007";
		/** 参数错误 */
