package plfx.mp.domain.model.platformpolicy;

import static plfx.mp.spi.common.MpEnumConstants.SalePolicySnapshotStatusEnum.STATUS_CANCEL;
import static plfx.mp.spi.common.MpEnumConstants.SalePolicySnapshotStatusEnum.STATUS_DEPLOY;
