...
import plfx.jd.pojo.system.enumConstants.EnumInvoiceMode;
/***
 * 
 * @类功能说明：订单详情DTO
 * @类修改者：
 ...
 * @部门：技术部
 * @作者：yaosanfeng
 * @创建时间：2015年6月24日下午4:56:33
 * @版本：V1.0
 *
 */
@SuppressWarnings("serial")
public class OrderDetailResultDTO extends OrderBaseDTO implements Serializable {
	/**
	 * 艺龙会员卡号
	 */
