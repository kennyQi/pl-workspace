...
public class LineConstants {
	 ...
	 * 线路类型
	 */
	public static final Map<String,String>	gradeMap = new TreeMap<String,String>();
	
	public final static String HOME = "1";
	public final static String ABROAD ="2";
	
	static{
		gradeMap.put(HOME + "", "国内线");
		gradeMap.put(ABROAD + "", "国外线");
	}
