 ...
 *
 */
public class LineNotifyMessageListener {
	...
	public void listen(Object message) {
		...
		//线路同步
		if(name.equals("plfx.xl.pojo.message.SynchronizationLineMessage")){
		...
		//通知线路订单状态改变
		if(name.equals("plfx.xl.pojo.message.NoticeUpdateLineOrderStatusMessage")){
		...
		//通知线路订单金额改变
		if(name.equals("plfx.xl.pojo.message.NoticeUpdateLineOrderSalePriceMessage")){
