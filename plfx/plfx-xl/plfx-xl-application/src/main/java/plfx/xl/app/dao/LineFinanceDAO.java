 ...
 * @部门：技术部
 * @作者：tandeng
 * @创建时间：2014年12月25日下午3:26:57
 * @版本：V1.0
 *
 */
@Repository
public class LineFinanceDAO extends BaseDao<LineOrder, LineFinanceQO>{

	@Override
	protected Criteria buildCriteria(Criteria criteria, LineFinanceQO qo) {
		//查询排序
