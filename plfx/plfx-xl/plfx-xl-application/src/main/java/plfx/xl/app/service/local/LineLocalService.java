...
import plfx.xl.app.dao.DayRouteDAO;
import plfx.xl.app.dao.LineDAO;
import plfx.xl.app.dao.LineImageDAO;
import plfx.xl.app.dao.LinePictureDAO;
import plfx.xl.app.dao.LinePictureFolderDAO;
...
//			lineImageDAO.saveList(newLineImageLists);
	...
	public List<Line> shopQueryList(LineQO qo) {
		...
		Integer pageNo = qo.getPageNo() == null ? new Integer(1) : qo.getPageNo();
		Integer pageSize = qo.getPageSize() == null ? new Integer(20) : qo.getPageSize();
		pagination.setPageNo(pageNo);
		pagination.setPageSize(pageSize);
		//添加查询条件
		pagination.setCondition(qo);
		List<Line> lines = (List<Line>) lineDAO.queryPagination(pagination).getList();
