...
import slfx.api.v1.request.command.xl.XLModifyLineOrderApiCommand;
...
public class TestXLAPI {
	...
	private final static String httpUrl = "http://192.168.10.68:8080/slfx-api/slfx/api";
//	private final static String httpUrl = "http://192.168.10.91:7101/slfx-api/slfx/api";
...
//	@Test
	public void testXLLineOrderPay(){
		...
		SlfxApiClient client = new SlfxApiClient(httpUrl,"XLPayLineOrder","123");
