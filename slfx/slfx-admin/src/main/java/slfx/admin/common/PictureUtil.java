...
public class PictureUtil {
	...
	public void uploadFile(MultipartFile file,String path, String name){
	    ...
	    try {
			...
			HgLogger.getInstance().error("tandeng", "PictureUtil->uploadFile->exception[上传文件]:" + HgLogger.getStackTrace(e));
		}
	}
...
//			File f = new File(srcFilePath);
			...
			HgLogger.getInstance().error("tandeng", "PictureUtil->resize->exception[缩放]:" + HgLogger.getStackTrace(e));
		}
	}
