...
import slfx.mp.domain.model.supplierpolicy.NoticeItem;
import slfx.mp.domain.model.supplierpolicy.NoticeType;
import slfx.mp.domain.model.supplierpolicy.ScenicSpotSnapshot;
...
import slfx.mp.tcclient.tc.domain.Info;
import slfx.mp.tcclient.tc.domain.Notice;
import slfx.mp.tcclient.tc.domain.Policy;
import slfx.mp.tcclient.tc.domain.PriceQueryScenery;
