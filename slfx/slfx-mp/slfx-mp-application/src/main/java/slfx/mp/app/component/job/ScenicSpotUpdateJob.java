...
import slfx.mp.app.service.local.ImageSpecLocalService;
...
import slfx.mp.domain.model.scenicspot.ScenicSpotsBaseInfo;
import slfx.mp.domain.model.scenicspot.ScenicSpotsGeographyInfo;
import slfx.mp.domain.model.scenicspot.TCScenicSpots;
import slfx.mp.domain.model.scenicspot.TCScenicSpotsTheme;
import slfx.mp.domain.model.supplierpolicy.TCPolicyNotice;
import slfx.mp.tcclient.tc.domain.ImagePath;
import slfx.mp.tcclient.tc.domain.ImageSize;
...
@Component
public class ScenicSpotUpdateJob {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext-slfx-mp.xml");
