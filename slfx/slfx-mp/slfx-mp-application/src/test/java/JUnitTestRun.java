...
//import slfx.mp.app.service.local.TCPolicyNoticeLocalService;
//import slfx.mp.app.service.local.TCScenicSpotsLocalService;
...
//import slfx.mp.tcclient.tc.domain.Scenery;
//
...
//	
//	@Autowired
//	ScenicSpotLocalService scenicSpotLocalService;
//	
//	/**
//	 * @方法功能说明：本地景区查询
//	 * @修改者名字：zhurz
//	 * @修改时间：2014-8-18下午2:28:14
//	 * @修改内容：
//	 * @参数：
//	 * @return:void
//	 * @throws
//	 */
//	@Test
//	public void queryScenicSpotList(){
//		ScenicSpotQO qo =new ScenicSpotQO();
//		qo.setName("杭州");
//		List<ScenicSpot> list=
//		scenicSpotLocalService.queryList(qo);
...
//	
//	@Autowired
//	TCScenicSpotsLocalService tcScenicSpotsLocalService;
//
//	@Test
//	public void testQueryTcScenicSpots() {
//		Pagination pagination = new Pagination();
//		TCScenicSpotsQO qo = new TCScenicSpotsQO();
//		pagination.setCondition(qo);
//		pagination = tcScenicSpotsLocalService.queryPagination(pagination);
//		String json=JSON.toJSONString(pagination, true);
//		System.out.println(json);
//	}
//	
//	@Autowired
//	TCPolicyNoticeLocalService tcPolicyNoticeLocalService;
//	
//	@Test
//	public void testTCPolicyNotice() {
//		Pagination pagination = new Pagination();
//		TCPolicyNoticeQO qo=new TCPolicyNoticeQO();
//		pagination.setCondition(qo);
//		pagination = tcPolicyNoticeLocalService.queryPagination(pagination);
//		String json=JSON.toJSONString(pagination, true);
//		System.out.println(json);
//	}
