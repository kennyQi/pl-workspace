...
//	@Test
//	public void testFlightCacheManager(){
//		System.out.println("aa="+flightCacheManager.getFlightDTO("aa"));
//	}
//	
...
//		HgLogger.getInstance().info("tandeng","set:" + jedis.set("test_set", "Hello World!"));
//		System.out.println("test_set==="+jedis.get("test_set"));
//	}
//
//	/**
//	 * 读取一个字符串
...
//		Jedis jedis = jedisPool.getResource();
//		jedis.flushAll();
//		HgLogger.getInstance().info("tandeng","get:" + jedis.get("test_set"));
//	}
//
//	/**
//	 * 写入一个新字符串并读取它的旧值
...
//	public void getSet() {
//		Jedis jedis = jedisPool.getResource();
//		HgLogger.getInstance().info("tandeng","getSet:" + jedis.getSet("test_set", "Hello!"));
//	}
//
//	/**
...
//	public void del() {
//		Jedis jedis = jedisPool.getResource();
//		HgLogger.getInstance().info("tandeng","del:" + jedis.del("test_set").toString());
//	}
//
//	/**
...
//	public void ttl() {
//		Jedis jedis = jedisPool.getResource();
//		HgLogger.getInstance().info("tandeng","ttl:" + jedis.ttl("test_set").toString());
//	}
//
//	/**
//	 * 将一个到期的key恢复为正常的key
...
//		//HgLogger.getInstance().info("tandeng",jedis.persist());
//	}
//
//	/**
//	 * 检查一个key是否存在
...
//	public void exists() {
//		Jedis jedis = jedisPool.getResource();
//		HgLogger.getInstance().info("tandeng","exists:" + jedis.exists("test_set").toString());
//	}
//
//	/**
//	 * 返回key所储存的值的类型
...
//		HgLogger.getInstance().info("tandeng","type:" + jedis.type("type_test"));
//		jedis.del("type_test");
//	}
//
//	/**
...
//		HgLogger.getInstance().info("tandeng","expire_test:" + jedis.expire("expire_test", 3));
//		HgLogger.getInstance().info("tandeng","expire_test:" + jedis.get("expire_test"));
//		Thread.sleep(3000);
//		HgLogger.getInstance().info("tandeng","expire_test:" + jedis.get("expire_test"));
//	}
//
...
//			HgLogger.getInstance().info("tandeng",value.toString());
//		}
//
//	}
//
...
//		Jedis jedis = jedisPool.getResource();
//		jedis.set("expire_test", "ok");
//		HgLogger.getInstance().info("tandeng","setex_test:" + jedis.setex("setex_test", 3, "ok"));
//		HgLogger.getInstance().info("tandeng","setex_test:" + jedis.get("setex_test"));
//		Thread.sleep(3000);
//		HgLogger.getInstance().info("tandeng","setex_test:" + jedis.get("setex_test"));
//	}
//
...
//		HgLogger.getInstance().info("tandeng",result1.get());
//		HgLogger.getInstance().info("tandeng",result2.get().get(0) + result2.get().get(1));
//
//	}
//
//	/**
...
//		jedis.set("1", "1");
//		jedis.set("2", "2");
//		HgLogger.getInstance().info("tandeng","1:" + jedis.get("1"));
//		jedis.flushAll();
//		HgLogger.getInstance().info("tandeng","1:" + jedis.get("1"));
//		HgLogger.getInstance().info("tandeng","2:" + jedis.get("2"));
//
//	}
//
//	/**
...
//		jedis.set("1", "1");
//		jedis.set("2", "2");
//		HgLogger.getInstance().info("tandeng","count:" + jedis.dbSize());
//		jedis.flushAll();
//
//	}
//
...
//		jedis.flushAll();
//		jedis.set("1", "10");
//		HgLogger.getInstance().info("tandeng","1:" + jedis.decr("1")); // 减1
//		HgLogger.getInstance().info("tandeng","1:" + jedis.decrBy("1", 2)); // 减n
//		HgLogger.getInstance().info("tandeng","1:" + jedis.incr("1")); // 加1
//		HgLogger.getInstance().info("tandeng","1:" + jedis.incrBy("1", 2)); // 加n
//		jedis.flushAll();
//	}
//
//	/**
...
//		LogFlow logFlow = new LogFlow("redis哈希操作", JedisTest.class,
...
//	public void list() {
//
//		LogFlow logFlow = new LogFlow("redis列表操作", JedisTest.class,
//				LogFlow.LOG_LEVEL_INFO);
//		Jedis jedis = jedisPool.getResource();
//		logFlow.record("创建连接");
//		jedis.flushAll();
...
//		Test1 t = new JedisTest.Test1();
//		t.setName("2233");
//		t.setAge("23");
//		Test1 t1 = new JedisTest.Test1();
//		t1.setName("gggg3");
//		t1.setAge("25");
...
//				JSONObject obj = (JSONObject) JSONObject.parse(entry.getValue()
//						.toString());
//
//				Test1 ddd11 = new JedisTest.Test1();
