	...
	<body>
		<div class="body">
			<div class="g_addPerson content">
				<!--表单值区域  -->
			    <form id="editPersonForm" method="POST" action="${ctx}/lineSalesPlan/addTravelerPage">
					<div class="ui-form-item ui-border-b m_input">
				            <label for="#"> 姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</label>
				            <input type="text" placeholder="姓名" id="person_name" name="name" value="${traveler.name}"/>
			        </div>
				    <div class="ui-form-item ui-border-b m_input">
				        <label for="#">手&nbsp;&nbsp;机&nbsp;&nbsp;号：</label>
				        <input type="text" placeholder="手机号" id="person_mobile" name="mobile" value="${traveler.mobile}"/>
				    </div>
			       ...
			       <div class="ui-form-item ui-border-b m_input">
			            ...
			            <input type="text" placeholder="输入证件号码"  id="person_num" name="cardNo" value="${traveler.cardNo}"/>
			        </div>
					<div class="m_btn" id="editPersonSure" >提&nbsp;&nbsp;&nbsp;&nbsp;交</div>
					
					<!--隐藏值区域  -->
					<input value="${traveler.id}" name="id" type="hidden">
