...
<html>
	<head>
		...
		<script language="javascript" src="${ctx}/resources/js/lspOrderList.js"></script>
	</head>
...
<body>
	...
	<header class="header">
	  ...
	  <div class="left-head"> <a id="goBack" href="javascript:history.go(-1);" class="tc_back head-btn"><span class="inset_shadow"><span class="head-return"></span></span></a> </div>
		...
		<div class="tips" id="tips"><i></i>点击加载更多活动订单...</div>
		...
		<div class="noOrder" style="display: none">
		    <div class="tips">
		        <i></i>您没有活动订单哦!
		        <a href="${ctx}/lineSalesPlan/buyActivitylist" class="choose">去抢购</a>
		    </div>
		</div>
