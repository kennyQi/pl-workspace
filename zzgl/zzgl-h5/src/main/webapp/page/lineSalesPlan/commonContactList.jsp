	...
	<body>
		...
		<div class="body">
			...
			<div class="content"  id="main" >
			    <!--新增游玩人表单  -->
			    <form action="${ctx}/lineSalesPlan/addCommonContact" id="personListAddForm"><div id="addpersonHiddenValue" style="display:none;"></div></form>
			    <!--编辑游玩人表单  -->
			        ...
			        <c:forEach items="${travelers}" var="traveler">
				        <li class="ui-border-t box" rel="${traveler.id}" choose="false" id="${traveler.id}">
				            ...
				            <h4 class="ui-nowrap person">
				                <input type="hidden" value="${traveler.id}" class="travelerId">
				                <span class="di">
				                	${traveler.name}
				            ...
				            <form action="${ctx}/lineSalesPlan/editCommonContact" id="personListEditForm"  style="display:none;"><div id="EditpersonHiddenValue" style="display:none;"></div>
		    ...
		    <div class="fixedBtn box">
		        <div class="leftBtn">已选择<i class="adult">0</i>成人</div>
		        <div class="next-btn">确定</div>
		    </div>
		    <!--表单区域  -->
		    <form action="${ctx}/lineSalesPlan/saveTraveler" id="personListSubmitForm">
