...
<section class="kajuan_nav"> 
  <a href="${ctx }/company/couponQuery?isAvailable=true" class="k_icon" id="k01">
  <div><i></i>可用代金券</div>
  </a> 
  <a href="${ctx }/company/couponQuery?isAvailable=false" class="k_icon" id="k02">
  <div><i></i>不可用代金券</div>
  </a> </section>
<section class="kajuan_info">
  <div style="display:none" id="kinfo01">
  <ul>     
  <c:forEach items="${couponQueryResult.couponDTOList }" var="coupon">
    <li>
      ...
      <div class="kalist">        
        <div class="ka_title">
<!--           <span class="ka_price_t">${coupon.baseInfo.couponActivity.baseInfo.name }</span> -->
  ...
  <div style="display:none" id="kinfo02">
  <ul>
  <c:forEach items="${couponQueryResult.couponDTOList }" var="coupon">
    <li> 
    <a href="${ctx }/company/couponDetail?id=${coupon.id}">  
