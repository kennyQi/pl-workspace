...
<!-- 城市列表 -->
    ...
    <div class="qn_header">
        <div class="back">
          <a style="margin:5px 0 0 10px;padding:10px;background:url(${ctx}/img/public/icon_back.png) center center no-repeat;background-size:11px 17px;" href="javascript:"></a>
        </div>
...
<script type="text/javascript">
 $(function(){  
   ...
   $("#citiesPage .back").click(function(){    
		$("#condition").show();
	    $("#citiesPage").hide();
   })
    /**
