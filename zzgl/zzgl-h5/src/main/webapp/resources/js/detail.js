...
$(function() {
    ...
    $(".detailTab:eq(0) .listCont").each(function(){
        var that=$(this);
        if($(this).find(".lineD").height()>60){
            $(this).find(".lineD").css({"height":"60px","overflow":"hidden"});
            $(this).find(".more").show();
        }
    });
    ...
    $(".detailTab:eq(0) .more").click(function(){
        var that=$(this);
        if(that.attr("moreOn")!="true"){
            that.closest(".listCont").find(".lineD").css("height","auto");
            that.find("i").html("&#xe6a2;");
            setTimeout(function(){
                that.attr("moreOn","true");
            },100);
            ...
            that.closest(".listCont").find(".lineD").css("height","60px");
        }
    });
