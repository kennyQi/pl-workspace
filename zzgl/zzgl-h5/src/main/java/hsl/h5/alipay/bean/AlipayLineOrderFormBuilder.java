...
import hsl.pojo.command.line.ApplyToPayLineOrderCommand.PaymentFormHtmlBuilder;
...
public class AlipayLineOrderFormBuilder implements PaymentFormHtmlBuilder {
	 ...
	 * @return
	 */
	private String getReqAuthonToken(AlipayWapTradeCreateDirect obj,String suffix) {
	...
	@Override
	public String buildAlipayFormHtml(String out_trade_no, String subject, double total_fee,String suffix) throws Exception {
		...
		// 请求业务参数详细
		String req_dataToken = getReqAuthonToken(obj,suffix);
