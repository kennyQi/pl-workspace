...
import hsl.admin.alipay.util.httpClient.HttpProtocolHandler;
import hsl.admin.alipay.util.httpClient.HttpRequest;
import hsl.admin.alipay.util.httpClient.HttpResponse;
import hsl.admin.alipay.util.httpClient.HttpResultType;
