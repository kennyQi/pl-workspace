...
public class LineIndexAdController {
	...
	public static final String ZBY_POSITION_ID= "zzgl_linead_zby";
	...
	public static final String GTY_POSITION_ID= "zzgl_linead_gty";
	...
	public String lineIndexAdZBYList(HttpServletRequest request,@RequestParam(value="pageNum",required=false) Integer pageNo, 
		...
		try{
			...
			pagination.setPageSize(pageSize == null ? 100 : pageSize);
			...
			e.printStackTrace();
			HgLogger.getInstance().error("chenxy", "lineIndexAdZBYList--周边游查询失败"+HgLogger.getStackTrace(e));
		}
	...
	public String lineIndexAdGTList(HttpServletRequest request,@RequestParam(value="pageNum",required=false) Integer pageNo, 
		...
		try {
			...
			e.printStackTrace();
			HgLogger.getInstance().error("chenxy", "lineIndexAdGTList--国内游查询失败"+HgLogger.getStackTrace(e));
		}
	...
	public String saveLineIndexAd(HttpServletRequest request,Model model,
		...
		try{
			...
			HgLogger.getInstance().error("chenxy", "添加线路首页广告回滚广告失败"+HgLogger.getStackTrace(e));
			e.printStackTrace();
