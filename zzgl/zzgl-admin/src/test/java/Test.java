...
//          Random r = new Random();  
//          System.out.println(MakeKey("renfeng", 0, r.nextInt(100000)));  
    	 
    	  System.out.println( checkTravelerTypeByIdno("510304200707025825"));
      }  
      
      public static Integer checkTravelerTypeByIdno(String idno) {
  		Date birthday;
  		if (idno.length() == 18)
