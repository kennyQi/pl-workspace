	    ...
	    $("#addgroup").click(function(){
	    	...
	    	if(name!=''){
	    		$.ajax({
			 		cache: true,
			 		type: "POST",
			 		url:'../company/organizeManage/addCompany?companyName='+encodeURI(encodeURI(name)),
			 		async: false,
	    ...
	    $("#adddepart").click(function(){
	    	...
	    	if(name!=''){
	    		$.ajax({
			 		cache: true,
			 		type: "POST",
			 		url:'../company/organizeManage/addDepartMent?deptName='+encodeURI(encodeURI(name))+'&companyId='+id,
			 		async: false,
			 	    error: function(request) {
			 	        alert("连接失败");
			 	    },
