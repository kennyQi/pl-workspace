...
//票量注释添加name属性
							var hajchange_m=m<9?("0"+(m+1)):(m+1);
							var hajchange_d=d<10?("0"+d):d;
							table+='<td data-date="'+d+'" name="'+y+hajchange_m+hajchange_d+'" data-month="'+m+'" data-year="'+y+'"'+' class="xdsoft_date xdsoft_day_of_week'+start.getDay()+' '+ classes.join(' ')+'" onclick="dateClick($(this));">'+
										'<div>'+d+'</div>'+
									'</td>';
...
//pl添加方法
						...
						mounth_picker.find('.xdsoft_label span').eq(1).text(_xdsoft_datetime.currentTime.getFullYear()+"年");
//pl添加方法
						addDate();
