package hsl.pojo.dto.jp.status;
...
public class JPOrderStatusConstant implements  Serializable{
	...
	public static final String SHOP_TICKET_REBACK_DEALING = "28";


	public static final String SHOP_PAY_WAIT_VAL = "待确认";
	public static final String SHOP_CANCEL_DEALING_VAL = "取消处理中";
	...
	public static final String SHOP_TICKET_REBACK_DEALING_VAL = "退款处理中";
	...
	static {
		...
		JPORDER_STATUS_LIST.add(new Attr(SHOP_TICKET_REBACK_DEALING, SHOP_TICKET_REBACK_DEALING_VAL));
...
//		JPORDER_STATUS_LIST.add(new Attr(SLFX_TICKET_TRY_AGAIN, SLFX_TICKET_TRY_AGAIN_VAL));
	...
	//分销支付状态
		...
		//用户支付状态
			...
			//商城支付状态
				...
				static {
					...
					SHOP_JPORDER_PAY_STATUS_LIST.add(new Attr(SHOP_TICKET_REBACK_DEALING, SHOP_TICKET_REBACK_DEALING_VAL));
		...
		static{
			...
			SHOP_JPORDER_USER_WAP_STATUS_LIST.add(new Attr(SHOP_TICKET_FAIL+SHOP_TICKET_REBACK_DEALING,"出票失败退款处理中"));
			SHOP_JPORDER_USER_WAP_STATUS_LIST.add(new Attr(SHOP_TICKET_SUCC+SHOP_TICKET_PAY_SUCC,"已出票"));
			SHOP_JPORDER_USER_WAP_STATUS_LIST.add(new Attr(SHOP_TICKET_REFUND_DEALING+SHOP_TICKET_TO_BE_BACK_WAIT,"退票处理中"));
	...
	static {
		...
		JPORDER_STATUS_MAP.put(SHOP_TICKET_REBACK_DEALING, SHOP_TICKET_REBACK_DEALING_VAL);
...
//		JPORDER_STATUS_MAP.put(SLFX_TICKET_TRY_AGAIN, SLFX_TICKET_TRY_AGAIN_VAL);
	...
	//用户支付状态
		...
		static{
			...
			SHOP_JPORDER_USER_WAP_STATUS_MAP.put(SHOP_TICKET_FAIL+SHOP_TICKET_REBACK_DEALING,"出票失败退款处理中");
			SHOP_JPORDER_USER_WAP_STATUS_MAP.put(SHOP_TICKET_SUCC+SHOP_TICKET_PAY_SUCC,"已出票");
			SHOP_JPORDER_USER_WAP_STATUS_MAP.put(SHOP_TICKET_REFUND_DEALING+SHOP_TICKET_TO_BE_BACK_WAIT,"退票处理中");
			...
			SHOP_JPORDER_USER_WAP_STATUS_MAP.put(SHOP_TICKET_REFUND_SUCC+SHOP_TICKET_REBACK_DEALING,"退票成功退款处理中");
		...
		static{
			...
			SHOP_JPORDER_USER_WAP_STATUS_TO_TICKET_MAP.put(SHOP_TICKET_REFUND_DEALING+SHOP_TICKET_TO_BE_BACK_WAIT,SHOP_TICKET_REFUND_DEALING);
		...
		static{
			...
			SHOP_JPORDER_USER_WAP_STATUS_TO_PAY_MAP.put(SHOP_TICKET_REFUND_DEALING+SHOP_TICKET_TO_BE_BACK_WAIT,SHOP_TICKET_TO_BE_BACK_WAIT);
		...
		//商城支付状态
			...
			static {
				...
				SHOP_JPORDER_PAY_STATUS_MAP.put(SHOP_TICKET_REBACK_DEALING, SHOP_TICKET_REBACK_DEALING_VAL);
...
//		STATUS_KEY_RELATION.put(APPLY_REFUND_DISCARD, YG_APPLY_REFUND_DISCARD);
    ...
    * 是否可支付
    */
   public Boolean canPay(JPBookOrderGNDTO order) {
      // TODO: implement
      return false;
   }
    ...
    * 是否可废票
    */
   public Boolean canDelete(JPBookOrderGNDTO order) {
      // TODO: implement
      return false;
   }
	...
	* 是否可退票
	*/
	public Boolean canCancel(JPBookOrderGNDTO order) {
		// TODO: implement
		return false;
	}
