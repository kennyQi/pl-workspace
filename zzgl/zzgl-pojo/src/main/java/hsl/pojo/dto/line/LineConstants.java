...
public class LineConstants {
	...
	public static final Integer DO_NOT_AUDIT = 1;//未审核
	public static final Integer AUDIT_FAIL = 2;//审核未通过
	public static final Integer AUDIT_SUCCESS = 3;//已审核
	public static final Integer AUDIT_UP = 4;//已上架
	public static final Integer AUDIT_DOWN = 5;//已下架
