...
public class HslLineQO extends BaseQo {
	...
	public final static String PAY_YES="1";

	public final static String PAY_No="2";

	public final static String BARGAIN_MONEY="1";//支付定金

	public final static String TRAIL_MONEY="2";//支付尾款

	public final static String ALL_MONEY="3";//全额支付
