...
public class MPOrderServiceImpl extends
	...
	public Map cancelMPOrder(MPOrderCancelCommand command) {
		...
		// 向商旅分销平台取消订单
		plfx.api.client.api.v1.mp.request.command.MPOrderCancelCommand slfxCommand = new plfx.api.client.api.v1.mp.request.command.MPOrderCancelCommand();
	...
	public Map createMPOrder(MPOrderCreateCommand mpOrderCreateCommand) {
		...
		plfx.api.client.api.v1.mp.request.command.MPOrderCreateCommand command = new plfx.api.client.api.v1.mp.request.command.MPOrderCreateCommand();
	...
	public void syncOrder(MPSyncOrderCommand command) {
		...
		// 向商旅分销平台同步订单状态请求
		plfx.api.client.api.v1.mp.request.command.MPSyncOrderCommand slfxSyncOrderCommand = new plfx.api.client.api.v1.mp.request.command.MPSyncOrderCommand();
