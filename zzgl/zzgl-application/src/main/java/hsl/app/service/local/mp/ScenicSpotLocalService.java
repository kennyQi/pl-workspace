...
//			}
	...
	public void createMPOrder(MPOrderCreateCommand mpOrderCreateCommand,MPOrderCreateResponse response,String dealerOrderId){
		...
		if("1".equals(response.getResult())){
			//查询景点政策信息
			plfx.api.client.api.v1.mp.request.qo.MPPolicyQO mpPolicyQO=new plfx.api.client.api.v1.mp.request.qo.MPPolicyQO();
			...
			//查询景点信息
			plfx.api.client.api.v1.mp.request.qo.MPScenicSpotsQO mpScenicSpotsQO=new plfx.api.client.api.v1.mp.request.qo.MPScenicSpotsQO();
