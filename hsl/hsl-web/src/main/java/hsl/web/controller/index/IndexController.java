...
public class IndexController extends BaseController {
	...
	public String index(HttpServletRequest request,Model model){
		...
		try {			
			...
			if(toppage.getList()!=null && toppage.getList().size()>0){
				request.getSession().setAttribute("topList", toppage.getList().get(0));
			}
	...
	/*		mpQO.setContentId("fa132c1dd9af498580276d5af4b0454d");
			...
			*/
			...
			lineIndexAdQO.setPositionId("hsl_linead_zby");
			...
			lineIndexAdQO2.setPositionId("hsl_linead_gty");
	...
	@RequestMapping(value = "/guoqing")
	public String guoqiang(HttpServletRequest request,Model model){
		return "activity/gq_index.html";
	}
}
