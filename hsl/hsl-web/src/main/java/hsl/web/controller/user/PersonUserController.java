...
//		if (requestUrl.indexOf("http://www.ply365.com") == 0) {
//			// 重定向到https登录页面
//			try {
//				response.sendRedirect(requestUrl.replace("http://", "https://"));
//			} catch (IOException e) {
//				HgLogger.getInstance().error(this.getClass(), "zhurz", "重定向异常", e);
//				e.printStackTrace();
//			}
//		}
	...
	public RedirectView userLogin(HttpServletRequest request, HttpServletResponse response, Model model,
