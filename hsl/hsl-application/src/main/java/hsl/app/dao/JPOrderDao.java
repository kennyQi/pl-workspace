...
@Repository
public class JPOrderDao extends BaseDao<JPOrder, HslJPOrderQO> {

	@Override
	protected Criteria buildCriteria(Criteria criteria, HslJPOrderQO qo) {
...
//		}
	...
	@Override
	public List<JPOrder> queryList(HslJPOrderQO qo) {
