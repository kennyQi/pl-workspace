...
public class YXResultCabinDTO extends BaseDTO {
	/**
	 * 舱位
	 */
	 ...
	 * 下单用加密串
	 */
	private String orderEncryptString;
	...
	public String getOrderEncryptString() {
		return orderEncryptString;
	}

	public void setOrderEncryptString(String orderEncryptString) {
		this.orderEncryptString = orderEncryptString;
	}
}
