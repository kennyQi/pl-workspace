...
public class YXResultFlightDTO extends BaseDTO {
	/**
	 * 始发地
	 */
	 ...
	 * 舱位信息
	 */
	private List<YXResultCabinDTO> cabinList;
	
	public List<YXResultCabinDTO> getCabinList() {
		return cabinList;
	}

	public void setCabinList(List<YXResultCabinDTO> cabinList) {
