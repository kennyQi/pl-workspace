...
//	public static final String SHOP_ORDER_SUCCESS_VAL="下单成功";
	...
	public static final String SHOP_REFUND_SUCCESS = "2108";
	...
	public static final String SHOP_REFUND_SUCCESS_VAL = "退款成功";
...
//		SHOP_XLORDER_STATUS_LIST.add(new Attr(SHOP_ORDER_SUCCESS,SHOP_ORDER_SUCCESS_VAL));
	...
	static {
		...
		SHOP_XLORDER_PAY_STATUS_LIST.add(new Attr(SHOP_REFUND_SUCCESS,SHOP_REFUND_SUCCESS_VAL));
	}
...
//		SHOP_XLORDER_STATUS_MAP.put(SHOP_ORDER_SUCCESS,SHOP_ORDER_SUCCESS_VAL);
	...
	static {
		...
		SHOP_XLORDER_PAY_STATUS_MAP.put(SHOP_REFUND_SUCCESS,SHOP_REFUND_SUCCESS_VAL);
	}
/*------------商城线路订单状态-end------------------------------------------------*/
