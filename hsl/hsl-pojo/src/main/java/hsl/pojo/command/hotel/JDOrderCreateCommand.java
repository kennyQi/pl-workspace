...
public class JDOrderCreateCommand implements Serializable{
	 ...
	 * 下单人
	 */
	private HotelOrderUserDTO hotelOrderUserDTO;
	
	
	

	public HotelOrderUserDTO getHotelOrderUserDTO() {
		return hotelOrderUserDTO;
	}

	public void setHotelOrderUserDTO(HotelOrderUserDTO hotelOrderUserDTO) {
		this.hotelOrderUserDTO = hotelOrderUserDTO;
	}
