...
//勾选游玩人
$(document).on("click","#personList .choose",function(){
...
//编辑游玩人
$(document).on("click","#personList .person",function(){
    var rel=$(this).closest("li").attr("rel");
    var name=$(this).find("span").html();
    var type=$(this).find("i.type").attr("rel");
    var num=$(this).find("i.cardid").html();
    var mobile=$(this).find("i.mobile").html();


    location.href="order_addperson.html?id="+rel;
});
