$(function(){
	...
	setInterval(function(){
		...
		$("#carousel .icon li").eq(rel).trigger("click");
	},3000);
...
var test2=new Vcity.CitySelector({input:'citySelect_to'});
var test=new Vcity.CitySelector({input:'citySelect_line_from'});
var test2=new Vcity.CitySelector({input:'citySelect_line_to'});
	...
	(function(){
		...
		rightHandle.click(function(){
			...
			rel++;
			if(!(obj.find(".list_box").is(":animated"))){
				if(rel==1){
					$list=obj.find(".list");
