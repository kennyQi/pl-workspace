      ...
      <input name="" type="hidden" value="">
        <article class="circle_b bottom_c radius passinfo" id="payInfo">
            <section class="secure selectBank" style="position: relative;">
                ...
                <span class="fRight">                    
                    <input name="oldPwd" id="oldPwd" placeholder="请输入旧密码" type="password" value="">
                </span>
            </section>
            <section class="secure selectBank" style="position: relative;">
                <span class="passname">新密码</span>
                <span class="fRight">
                    <input name="newPwd" id="newPwd" placeholder="请输入新密码" type="password" value="" >
                </span>
            </section>
            <section class="secure " style="position: relative;">
                <span class="passname">确认新密码</span>
                <span class="fRight">
                    <input name="verify" id="verify" placeholder="确认新密码" type="password" value="" >
                </span>
            </section>           
        </article>       
        <div class="col_div">
