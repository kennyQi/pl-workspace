    ...
    <form action="${ctx}/user/check?openid=${openid}" class="listForm" id="queryForm" method="post">
        ...
        <article class="circle_b bottom_c radius" id="payInfo">
            <section class="secure selectBank" style="position: relative;">
                ...
                <span class="fRight">
                    <input name="loginName" id="loginName" placeholder="请输入您的用户名/手机号" type="text" value="" maxlength="32">
            ...
            <section style="position: relative;">
                ...
                <span class="fRight">
                    <input id="password" name="password" id="pass" placeholder="请输入您的密码" type="password">
                </span>
            </section>
        </article>
