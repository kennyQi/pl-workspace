...
//    	prestr = prestr.substring(0,prestr.length()-1);
    	...
    	String prestr = "service="+params.get("service")+"&v="+params.get("v")+"&sec_id="+params.get("sec_id")+"&notify_data="+params.get("notify_data");
    	return prestr;
    }
    ...
    public static void logResult(String sWord) {
        ...
        try {
            writer = new FileWriter(SysProperties.getInstance().get("alipay_log_path") + "alipay_log_" + System.currentTimeMillis()+".txt");
            writer.write(sWord);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
