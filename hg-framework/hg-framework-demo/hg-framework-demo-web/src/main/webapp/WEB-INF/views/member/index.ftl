...
<#-- @ftlvariable name="sqo" type="hg.demo.member.common.spi.qo.DepartmentSQO" -->
<#-- @ftlvariable name="pagination" type="hg.framework.common.model.Pagination" -->
...
<#-- @ftlvariable name="dep" type="hg.demo.member.common.domain.model.Department" -->
	<tr>
		<td>${dep.id!?html}</td>
		<td>${dep.name!?html}</td>
	</tr>
